...
def main():
    ...
    for race_id in update_race_id_list:
        race_data.update_data( COLUM_NAME, json.dumps( result[race_id], ensure_ascii = False ), race_id )

    prod_data.update_data( COLUM_NAME, json.dumps( prod_analyze_data, ensure_ascii = False ) )
